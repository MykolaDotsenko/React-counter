...
- total public JavaScript without the engines: <= 435,000 raw / 131,500 gzip bytes;
- initial JavaScript referenced by the public HTML: <= 390,000 raw / 115,500 gzip bytes, and it must contain neither engine;
...
- total public CSS: <= 80,000 raw / 15,300 gzip bytes;
- initial CSS referenced by the public HTML: <= 62,000 raw / 10,600 gzip bytes.
