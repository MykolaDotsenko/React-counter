...
- total public JavaScript without the engines: <= 440,000 raw / 132,000 gzip bytes;
- initial JavaScript referenced by the public HTML: <= 393,000 raw / 116,000 gzip bytes, and it must contain neither engine;
