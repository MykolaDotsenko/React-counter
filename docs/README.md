...
Detailed executable contracts live in [specs/](./specs/). Specialized contracts such as [DATA-PERSISTENCE.md](./DATA-PERSISTENCE.md) and [ACCESSIBILITY.md](./ACCESSIBILITY.md) refine the authoritative documents; they do not replace them.
...
- [FUNCTIONALITY.md](./FUNCTIONALITY.md) — extended functional catalogue and edge-case reference
- [UX.md](./UX.md) — detailed UX heuristics and interaction reference
- [BRAND.md](./BRAND.md) — brand, voice, naming, and messaging reference
- [SCENARIOS.md](./SCENARIOS.md) — scenario inventory and risk analysis
- [TECH-STACK.md](./TECH-STACK.md) — technology rationale and future candidates
- [MARKETING.md](./MARKETING.md) — acquisition/positioning strategy, not implementation status
...
- [SPRINT-B-QUALITY-GATE.md](./SPRINT-B-QUALITY-GATE.md) — physical timing and one-hand evidence contract
- [RETENTION-BETA.md](./RETENTION-BETA.md) — retention instrumentation contract
- [RETENTION-BETA-PLAYBOOK.md](./RETENTION-BETA-PLAYBOOK.md) — real-store retention study protocol
- [BRAND-IMPLEMENTATION-AUDIT.md](./BRAND-IMPLEMENTATION-AUDIT.md) — implementation audit evidence
- [design/PHASE-4-DESIGN-VALIDATION.md](./design/PHASE-4-DESIGN-VALIDATION.md) — design validation evidence
...
- [PRODUCT-SUCCESS-STRATEGY.md](./PRODUCT-SUCCESS-STRATEGY.md)
- [tech/TECHNOLOGY-RESEARCH.md](./tech/TECHNOLOGY-RESEARCH.md)
- [marketing/RESEARCH.md](./marketing/RESEARCH.md)
