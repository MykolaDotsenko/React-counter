# Archived roadmap through repeat-trip engineering

> Historical snapshot preserved on 2026-09-22 when the current roadmap was compressed around active evidence gates and future sequencing.
>
> This file is **not a current implementation contract**. Use [../ROADMAP.md](../ROADMAP.md) for current priorities.
