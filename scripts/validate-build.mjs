...
const MAX_PUBLIC_JS_BYTES = 435_000;
const MAX_INITIAL_JS_BYTES = 390_000;
const MAX_SINGLE_JS_CHUNK_BYTES = 380_000;
const MAX_PUBLIC_JS_GZIP_BYTES = 131_500;
const MAX_INITIAL_JS_GZIP_BYTES = 115_500;
const MAX_PUBLIC_CSS_BYTES = 80_000;
const MAX_INITIAL_CSS_BYTES = 62_000;
const MAX_PUBLIC_CSS_GZIP_BYTES = 15_300;
