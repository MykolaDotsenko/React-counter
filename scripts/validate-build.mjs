...
const MAX_INITIAL_JS_BYTES = 385_000;
const MAX_SINGLE_JS_CHUNK_BYTES = 380_000;
const MAX_PUBLIC_JS_GZIP_BYTES = 130_000;
const MAX_INITIAL_JS_GZIP_BYTES = 114_000;
const MAX_PUBLIC_CSS_BYTES = 80_000;
const MAX_INITIAL_CSS_BYTES = 61_000;
const MAX_PUBLIC_CSS_GZIP_BYTES = 15_000;
const MAX_INITIAL_CSS_GZIP_BYTES = 10_300;
